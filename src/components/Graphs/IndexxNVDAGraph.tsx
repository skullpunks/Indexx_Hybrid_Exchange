...
const IndexxNVDAGraph = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${baseAPIURL}/api/v1/inex/basic/stockdata?interval=${interval}&symbol=${"NVDA"}`)
            ...
            <div>
                ...
                >
                    ...
                    >
                        ...
                        <img
                            src={
                                require(`../../assets/token-icons/NVDA.png`)
                                    .default
                            }
                            alt="bitcoin"
                            width="30"
...
export default IndexxNVDAGraph;
