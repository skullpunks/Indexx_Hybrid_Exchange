...
const BasicInfo = ({ theme }: { theme: any }) => {
  ...
  const renderVerificationStep = () => {
    if (!userData?.verification?.emailVerified) {
      // Step 1: Show Basic Functions and Email Verification
      return (
    ...
    } else if (!userData?.personalIdNumber) {
      return (
        <div className="col-lg-5 bs_main">
          <h1
            className="font_18x margin-tb-2x d-block font_weight_800 "
            style={{ color: theme.palette.text.primary }}
          >
            SSN Verification
          </h1>
      ...
      // Step 3: Show Advanced Verification
      return (
        ...
        <div>
          ...
          <div className="padding-2x row">
            <div className="col-lg-5">
              ...
              <div
                className={`verification-box margin-t-2x ${
                  !userData?.verification?.emailVerified
              ...
              >
                <div
                  className="d-flex align-items-center padding-1x"
                  style={{
                    border: `1px solid ${theme.palette.divider}`,
                    borderRadius: '8px',
                  }}
                    ...
                    {!userData?.personalIdNumber &&
                      userData?.verification?.emailVerified && (
                        <div className="font_12x opacity-50">
                          Complete SSN verification to proceed with advanced
                          verification
                        </div>
                      )}
                  </div>
              ...
              <div
                className={`verification-box margin-t-2x ${
                  !userData?.personalIdNumber ? 'disabled-verification' : ''
                }`}
              >
                <div
                  className={
