...
const SecurityChange = () => {
  ...
  const [loadings, setLoadings] = useState<boolean>(false);
    ...
    const onFinish = async (values: any) => {
        ...
        await changePassword(String(decoded.email), values.newpassword, values.oldpassword).then((res) => {
            if (res.status === 200) {
                setLoadings(false);
        ...
        <div className="" style={{ marginTop: 142 }}>
            ...
            <div className="card margin-lr-auto bs_main padding-2x security_change">
                <div className="d-flex row">
                    ...
                    <p className="col-lg-11 padding-0">To keep your account secure, withdrawals are not permitted for <b>24 hours</b> after changing your password.</p>
                </div>
                <Form
                    onFinish={onFinish}
                            ...
                            rules={[
                                ...
                                ({ getFieldValue }) => ({
                                    validator(_, value) {
                                        ...
                                        setError(true);
                                        return Promise.reject(new Error('Old password and new passowrd should be be different!'));
                                    },
                                }),
                            ]}
                            hasFeedback
                    ...
                    {/* <Button type="primary" className="margin-t-auto font_!8x"><Link to="/indexx-exchange/account"> Confirm Changes</Link></Button>
                    <Button type="primary" className="margin-t-auto font_!8x"><Link to="/indexx-exchange/account"> Confirm Changes</Link></Button> */}
                    <Button type="primary" className={isError ? "disable_icon" : "atn-btn atn-btn-round margin-b-1x"} 
                     loading={loadings}
