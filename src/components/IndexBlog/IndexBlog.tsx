        ...
        <div>
            <div className='swap_container blog_container' style={{ paddingBottom: 200 }}>
                ...
                <div className="margin-t-2x blog_container_main">
                    <div className='d-flex flex-justify-between margin-b-3x padding-b-3x'>
                    ...
                    <div className='d-flex flex-justify-between flex-wrap'>
                        <div className='flex-b-50 border-1x margin-b-2x'>
                            ...
                            <p className='font_48x padding-lr-2x padding-t-2x'>Indexx 500 and Indexx Crypto’s presale is ON!</p>
                        ...
                        <div className='flex-b-50 border-1x  margin-tb-2x'>
                            ...
                            <p className='font_48x padding-lr-2x padding-t-2x'>Indexx 500 Opens a new way to Index funds</p>
                        ...
                        <div className='flex-b-50 border-1x  margin-tb-2x'>
                            ...
                            <p className='font_48x padding-lr-2x padding-t-2x'>Indexx, the future of Stock Tokens — An Asset-Backed token by S&P 500 holdings</p>
