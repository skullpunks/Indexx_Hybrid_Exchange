        ...
        <div>
            <div className='swap_container blog_container' style={{ paddingBottom: 200 }}>
                ...
                <div className="margin-t-2x blog_container_main">
                    <div className='d-flex flex-justify-between margin-b-3x padding-b-3x' onClick={() => onClickHandler("https://medium.com/@Indexx/a-deeper-look-into-what-makes-indexx-work-with-brian-zheng-6cbfae9307b1")}>
                    ...
                    <div className='d-flex flex-justify-between flex-wrap'>
                        <div className='flex-b-50 border-1x margin-b-2x' onClick={() => onClickHandler("https://medium.com/@Indexx/indexx-500-and-indexx-cryptos-presale-is-on-160da8cc9f45")}>
                            <img src={IndexPreSaleIcon} alt="IndexPreSaleIcon" className='width-100' />
                            <p className='font_40x padding-lr-2x padding-t-2x'>Indexx 500 and Indexx Crypto’s presale is ON!</p>
                        ...
                        <div className='flex-b-50 border-1x  margin-b-2x' onClick={() => onClickHandler("https://medium.com/@Indexx/indexx-family-new-products-launching-eb049862a913")}>
                            <img src={indexFamilyToken} alt="indexFamilyToken" className='width-100' />
                            <p className='font_40x padding-lr-2x padding-t-2x'>Indexx family — New products launching</p>
                            <p className='font_23x padding-lr-2x margin-t-2x margin-b-3x ' > As per our last announcement, we have some exciting news to share with you all.</p>
                            <span className='font_20x text-center d-block padding-b-1x'>August 23, 2022 - 2 min read</span>
                        </div>
                        <div className='flex-b-50 border-1x  margin-tb-2x' onClick={() => onClickHandler("https://medium.com/@Indexx/indexx-500-opens-a-new-way-to-index-funds-508eb27a7a15")}>
                            <img src={indexFund} alt="indexFund" className='width-100' />
                            <p className='font_40x padding-lr-2x padding-t-2x'>Indexx 500 Opens a new way to Index funds</p>
                        ...
                        <div className='flex-b-50 border-1x  margin-tb-2x' onClick={() => onClickHandler("https://medium.com/@Indexx/indexx-the-future-of-stock-tokens-an-asset-backed-token-by-s-p-500-holdings-282f6342df8e")}>
                            <img src={indexFinance} alt="indexFinance" className='width-100' />
                            <p className='font_40x padding-lr-2x padding-t-2x'>Indexx, the future of Stock Tokens — An Asset-Backed token by S&P 500 holdings</p>
