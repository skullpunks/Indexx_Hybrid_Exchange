...
import ca from '../../assets/token-icons/DAI.png';
...
const DaiMarket = () => {
    ...
    useEffect(() => {
        marketsData().then((res) => {
            let requiredData = res.data.find((x: { Symbol: string; }) => x.Symbol === "DAI");
                        ...
                        <p style={{ fontSize: 10 }}>
                            <div className="row">
                                ...
                                <div className="col" style={{ textAlign: 'left' }}>
                                    ...
                                    <p style={{ fontSize: 10, color: 'var(--body_color)' }}>{data?.CirculatingSupply} DAI</p><br />
