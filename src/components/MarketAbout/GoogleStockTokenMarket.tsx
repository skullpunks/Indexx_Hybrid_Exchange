...
import ca from '../../assets/token-icons/GOOGL.png';
import { marketsData, stockMarketsData } from '../../services/api';
import { useEffect, useState } from 'react';

const GoogleStockTokenMarket = () => {
    const { Panel } = Collapse;
    const [data, setData] = useState() as any;
    useEffect(() => {
        stockMarketsData("GOOGL").then((res) => {
            ...
            <div className="coll">
                ...
                >
                    ...
                    >
                        ...
                        <div className="row">
                                ...
                                <div className="col" style={{ textAlign: 'left' }}>
                                    ...
                                    <p style={{ fontSize: 10, color: 'var(--body_color)' }}>{data?.CirculatingSupply} GOOGL</p><br />
                    ...
                    <Panel
                        ...
                        header="About Indexx Google Stock Token"
                        key="2"
                    ><Divider style={{ marginTop: -20 }}></Divider>
                        <div style={{ textAlign: 'left', color: 'var(--body_color)' }}>
                            ...
                            <p style={{ fontSize: 20 }}>GOOGL Token </p>
                            <p style={{ fontSize: 15, lineHeight: 2 }}>
                            Google's GOOG stock token grants you ownership in Alphabet Inc., the parent company of Google. GOOG tokens are essential for those who want to partake in the future developments of the world's leading search engine and technology company. With a current price per GOOG stock token of $2,500, it's an ideal time to invest, with potential for value appreciation in the coming months.
                            </p>
                            <br />
                        </div>
                    </Panel>
...
export default GoogleStockTokenMarket;