...
import ca from '../../assets/token-icons/PEP.png';
import { marketsData, stockMarketsData } from '../../services/api';
import { useEffect, useState } from 'react';

const PespiCoStockTokenMarket = () => {
    const { Panel } = Collapse;
    const [data, setData] = useState() as any;
    useEffect(() => {
        stockMarketsData("PEP").then((res) => {
            ...
            <div className="coll">
                ...
                >
                        ...
                        <p style={{ fontSize: 10 }}>
                            <div className="row">
                                ...
                                <div className="col" style={{ textAlign: 'left' }}>
                                    ...
                                    <p style={{ fontSize: 10, color: 'var(--body_color)' }}>{data?.CirculatingSupply} PEP</p><br />
                    ...
                    <Panel
                        ...
                        header="About Indexx PepsiCo Stock Token"
                        key="2"
                    ><Divider style={{ marginTop: -20 }}></Divider>
                        <div style={{ textAlign: 'left', color: 'var(--body_color)' }}>
                            ...
                            <p style={{ fontSize: 20 }}>PEP Token </p>
                            <p style={{ fontSize: 15, lineHeight: 2 }}>
                                Pepsico's PEP stock token represents a share in one of the world's leading food and beverage companies. Holding PEP stock tokens enables you to participate in Pepsico's global growth and portfolio of popular brands. The current price per PEP stock token is $150, and it's expected to see value growth within the next 3 - 6 months.
                            </p>
                            <br />
                        </div>
                    </Panel>
...
export default PespiCoStockTokenMarket;