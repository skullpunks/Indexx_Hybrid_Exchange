...
import ca from '../../assets/token-icons/AMZN.png';
import { marketsData, stockMarketsData } from '../../services/api';
import { useEffect, useState } from 'react';

const AmazonStockTokenMarket = () => {
    const { Panel } = Collapse;
    const [data, setData] = useState() as any;
    useEffect(() => {
        stockMarketsData("AMZN").then((res) => {
            ...
            <div className="coll">
                ...
                >
                    ...
                    >
                        ...
                        <div className="row">
                                ...
                                <div className="col" style={{ textAlign: 'left' }}>
                                    ...
                                    <p style={{ fontSize: 10, color: 'var(--body_color)' }}>{data?.CirculatingSupply} AMZN</p><br />
                    ...
                    <Panel
                        ...
                        header="About Indexx Amazon Stock Token"
                        key="2"
                    ...
                    ><Divider style={{ marginTop: -20 }}></Divider>
                        <div style={{ textAlign: 'left', color: 'var(--body_color)' }}>
                            ...
                            <p style={{ fontSize: 20 }}>AMZN Token </p>
                            <p style={{ fontSize: 15, lineHeight: 2 }}>
                                Amazon's AMZN stock token offers ownership in the world's largest online retailer and cloud services provider, Amazon.com Inc. By holding AMZN tokens, you become a part of Amazon's continuous expansion and dominance in e-commerce and technology. The current price per AMZN stock token is $3,000, with potential for value growth in the next 3 - 6 months.
                            </p>
                            <br />
                        </div>
                    </Panel>
...
export default AmazonStockTokenMarket;