...
const TelsaStockTokenMarket = () => {
    const { Panel } = Collapse;
    const [data, setData] = useState() as any;
    useEffect(() => {
        stockMarketsData("TSLA").then((res) => {
            ...
            <div className="coll">
                ...
                >
                    ...
                    >
                        ...
                        <div className="row">
                                ...
                                <div className="col" style={{ textAlign: 'left' }}>
                                    ...
                                    <p style={{ fontSize: 10, color: 'var(--body_color)' }}>{data?.CirculatingSupply} TSLA</p><br />
                    ...
                    <Panel
                        ...
                        header="About Indexx Tesla Stock Token"
                        key="2"
                    ><Divider style={{ marginTop: -20 }}></Divider>
...
export default TelsaStockTokenMarket;