...
import ca from '../../assets/token-icons/LEO.png';
...
const LEOMarket = () => {
    ...
    useEffect(() => {
        marketsData().then((res) => {
            let requiredData = res.data.find((x: { Symbol: string; }) => x.Symbol === "LEO");
                        ...
                        <p style={{ fontSize: 10 }}>
                            <div className="row">
                                ...
                                <div className="col" style={{ textAlign: 'left' }}>
                                    ...
                                    <p style={{ fontSize: 10, color: 'var(--body_color)' }}>{data?.CirculatingSupply} LEO</p><br />
