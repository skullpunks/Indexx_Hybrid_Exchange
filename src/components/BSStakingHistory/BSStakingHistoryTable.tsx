...
const BSStakingHistoryTable: React.FC<HistoryProps> = ({ refresh }) => {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      // responsive: ['sm'],
      sorter: (a, b) =>
        moment(a.endDate).valueOf() - moment(b.endDate).valueOf(),
      sortDirections: ['descend', 'ascend'],
    },
    {
      title: 'Staked Amount',
      ...
      render: (_, record) => (
        <span>
          {record.coin === record.rewardCoin ? (
            <>
              {String((record.stakedAmount + record.rewardAmount).toFixed(2))}{' '}
              {record.coin}
            </>
          ) : (
            <>
              {String(record.stakedAmount.toFixed(2))} {record.coin} {'+'}{' '}
              {String(record.rewardAmount.toFixed(2))} {record.rewardCoin}
            </>
          )}
        </span>
      ),
    ...
    },
    {
      ...
      key: 'percentage',
      render: (percentage) => <span>{percentage * 100}%</span>,
      // responsive: ["sm"],
    ...
    <div className="flex-align-stretch bs_main width-100  margin-t-3x padding-t-2x ">
      <div className="d-flex transaction_filters margin-b-3x">
        <div style={{ color: theme.palette.text.primary }}>
          <label style={{ color: theme.palette.text.primary }}>Type</label>{' '}
          <br />
          <Select
            defaultValue="all"
        ...
        <div
          ...
          style={{ color: theme.palette.text.primary }}
        >
          <label style={{ color: theme.palette.text.primary }}>Time</label>{' '}
          <br />
          <Select
            defaultValue="30"
        ...
        <div
          ...
          style={{ color: theme.palette.text.primary }}
        >
          <label style={{ color: theme.palette.text.primary }}>Asset</label>{' '}
          <br />
          <Select
            defaultValue="all"
        ...
        <div className="d-md-block d-none">
          <label style={{ color: theme.palette.text.primary }}>Status</label>{' '}
          <br />
          <Select
            defaultValue="all"
