...
const BuySellLoginFail: React.FC<(Props)> = ({ setScreenName }) => {
    ...
    return (
        <div className="bs_container bs_form card card_s">
            ...
            <br />
            <br />
            <Button type="primary" className="atn-btn atn-btn-round margin-b-1x" onClick={() => navigate("/indexx-exchange/buy-sell/login")} style={{ height: 55, borderColor: "#F66036", backgroundColor: "#F66036", color: "#fff", fontSize: 20, borderRadius: 5 }} block>Ok</Button>
        </div>
    )
}
