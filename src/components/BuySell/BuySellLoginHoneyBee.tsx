...
import BuySellLoginContentHoneyBee from './BuySellLoginContentHoneyBee';

const BuySellLoginHoneyBee = () => {
    ...
    return (
        <>
            <div className='scan-container flex-align-stretch bs_main'>
                ...
                <Routes>
                    <Route index element={<BuySellLoginContentHoneyBee setScreenName={setScreenName} />} />
...
export default BuySellLoginHoneyBee