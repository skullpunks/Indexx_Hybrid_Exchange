...
const BuySellAllLoginContent: React.FC<Props> = ({ setScreenName }) => {
  ...
  return (
    <div className="d-flex justify-content-center" style={{gap:2, width:"85%"}}>

<div className="d-flex flex-direction-column col-md-4 responsive_container flex-align-center">
        <h3 className="text-center margin-lr-auto"><img src={hat} alt="noramluser" /></h3>
        <h1 className="text-center margin-lr-auto font_30x">Login as Captain Bee</h1>
...
>
    ...
    <div className="d-flex flex-direction-column col-md-4 responsive_container flex-align-center">
      <h3 className="text-center margin-lr-auto"><img src={bee} alt="noramluser" style={{width:"81px"}}/></h3>
        <h1 className="text-center margin-lr-auto font_30x" style={{marginTop:"-8px"}}>Login as Honey Bee</h1>
      <div className="text-center margin-lr-auto padding-tb-2x">
        Please make sure you are visiting the correct URL
      </div>
      <p className="w-fit-content py-1 p-2 index_link_info">
      ...
      <div className="d-flex flex-direction-column col-md-4 responsive_container flex-align-center">
      <h3 className="text-center margin-lr-auto"><img src={normaluser} alt="noramluser" /></h3>
        <h1 className="text-center margin-lr-auto font_30x">Login as Indexx User</h1>
        <div className="text-center margin-lr-auto padding-tb-2x">
          Please make sure you are visiting the correct URL
        </div>
        <p className="w-fit-content py-1 p-2 index_link_info">
