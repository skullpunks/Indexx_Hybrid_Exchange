    ...
    return (<div className='d-flex flex-direction-column col-lg-5 col-md-12 flex-align-center responsive_container'>
        ...
        <div className="bs_container bs_form card secure-steps">
            ...
            <div className="font_20x padding-l-1x d-flex flex-align-center">
                <img src={completedCheck} alt="completedCheck" className="padding-r-1_x" /><div>Create Your Account</div> 
            </div>
           
            <div className="font_20x padding-t-1x padding-l-1x d-flex flex-align-center" >
                <img src={inProgressIcon} alt="inProgressIcon" className="padding-r-1_x" /> <div>Secure Your Account</div>
            </div>
           
            <div className="font_20x padding-t-1x padding-l-1x d-flex flex-align-center">
                <img src={futureIcon} alt="futureIcon" className="padding-r-1_x" /><div>Complete Identity Verification</div>
            </div>
