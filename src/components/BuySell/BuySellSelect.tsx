    ...
    return(
        <div className="bs_container card">
                <div className="bs_container_header d-flex border-b-0">
                    <img src={arrowAdressLeft} alt="adressLeft"  style={{paddingRight:8}}/>
                    <h1>Select Coin</h1>
                </div>
                ...
                <div className="token_container  flex-justify-between common_tokens" style={{maxHeight: 395,
    overflowY: "auto"}} onClick={() => setScreenName("create")}>
                {
