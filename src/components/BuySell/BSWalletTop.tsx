        ...
        <>
            ...
            <div className='padding-t-1x width-100 bs_wallet_top_banner position-relative' >
                ...
                <div className='bs_wallet_buttons d-flex'>
                    ...
                    <Button className='light_button ant-btn ant-btn-dangerous danger_disabled width_auto deposit_btn margin-r-1x' onClick={() => navigate("/indexx-exchange/buy-sell/withdraw-crypto")}> Deposit </Button>
                    <Button className='light_button ant-btn ant-btn-dangerous danger_disabled width_auto deposit_btn withdraw_btn' onClick={() => navigate("/indexx-exchange/buy-sell/deposit-crypto")}> Withdraw </Button>
