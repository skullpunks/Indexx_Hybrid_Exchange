...
import iconLogo from '../../../assets/updated/smartCrypto/demoInvestment.svg';
      ...
      <div className="bnModalWrap">
        <div className={classes.contentContainer}>
          ...
          <div className={classes.header}>
            <img src={iconLogo} />
            <h2>
              Welcome <br /> to Smart Crypto Demo <br />
              Version!
            </h2>
          </div>
          ...
          <div className={classes.planDetails}>
            <p>
              You have <span style={{ fontWeight: 600 }}>3</span> simple steps
              to follow to start your crypto journey.
            </p>
          </div>
...
export default DemoInvestmentPopup;
