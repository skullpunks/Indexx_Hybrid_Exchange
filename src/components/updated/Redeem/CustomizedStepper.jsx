...
import greenActiveIcon from '../../../assets/stepper/greenActive.png'; // Make sure the path is correct
...
const ColorlibStepIconRoot = styled('div')(({ theme, ownerState }) => ({
  ...
  ...(ownerState.completed && {
    backgroundImage: `url(${greenActiveIcon})`, // Fix backgroundImage value
  }),
}));
...
const steps = ['Create Card', 'Receiver Details', 'Payment Details'];

export default function CustomizedSteppers({ step }) {
  return (
    <Stack
      sx={{ width: '100%', maxWidth: '800px', margin: '100px auto' }}
      spacing={4}
    >
      <Stepper
        alternativeLabel
